...
Here is a comparison using the default test generated by Rails'
scaffolding. It has been written in a functional style and then in a
unit style. You can see that the unit style runs about 4 times faster.

```
$ ruby -Itest test/functional/posts_controller_test.rb
Run options:
...
Finished tests in 0.126487s, 55.3416 tests/s, 79.0595 assertions/s.

7 tests, 10 assertions, 0 failures, 0 errors, 0 skips
```

```
$ ruby -Itest test/unit/controllers/posts_controller_test.rb
Run options:
...
Finished tests in 0.031638s, 221.2510 tests/s, 316.0728 assertions/s.
